...
//    private var lastMatchId: matchPackage.ID? {
//        matchPackage.matches.last?.id
//    }
                        ...
                        ForEach(matchPackage.matches) { matchPackage in
                            ZStack {
                                ZStack {
                                    ...
                                    HStack {
                                        Spacer()
                                        if matchPackage.win != nil && matchPackage.matchId.contains("F") {
                                            EmptyView()
                                        } else {
...
//                    }
//                    .onChange(of: matchPackage.matches.count) { oldValue, newValue in
//                        if oldValue != newValue {
//                            if let lastId = lastMatchId {
//                                withAnimation {
